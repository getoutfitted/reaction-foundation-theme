Template.foundationOrderWidgets.helpers


Template.foundationOrderWidgets.events


Template.foundationOrderWidgets.rendered = ->
  # get data
  now = new Date()
  age = 5
...
Template.foundationOrderWidgets.destroyed = ->
  # destroy graphs
