...
Template.foundationAccounts.events
...
Template.foundationUnauthorized.inheritsHelpersFrom "accounts"
Template.foundationUnauthorized.inheritsEventsFrom "accounts"
