Template.foundationProductDetailEdit.helpers
  i18nPlaceholder: () ->
    i18nextDep.depend()
...
Template.foundationProductDetailEdit.events
...
Template.foundationProductDetailField.events
...
Template.foundationProductDetailEdit.rendered = () ->
  $('textarea').autosize()
