...
Template.foundationProductGrid.helpers
  products: ->
    ###
...
Template.foundationProductGridItems.helpers
  media: (variant) ->
...
Template.foundationGridNotice.helpers
...
Template.foundationGridContent.helpers
  displayPrice: () ->
    getProductPriceRange(@_id) if @_id

Template.foundationProductGridItems.events
  'click .clone-product': () ->
    title = @.title
...
Template.foundationProductGridItems.rendered = () ->
  # *****************************************************
