Template.foundationProductDetailTags.helpers
  currentHashTag: () ->
    if selectedProduct()?.handle is @.name.toLowerCase()
      return true

Template.foundationProductTagInputForm.helpers
  hashtagMark: () ->
    if selectedProduct()?.handle is @.name.toLowerCase()
      return "fa-bookmark"
    else
...
Template.foundationProductTagInputForm.events
...
Template.foundationProductTagInputForm.rendered = ->
  # *****************************************************
